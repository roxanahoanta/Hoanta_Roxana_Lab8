...
namespace Hoanta_Roxana_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Hoanta_Roxana_Lab8Context context,Book book)
        {
        ...
        public void UpdateBookCategories(Hoanta_Roxana_Lab8Context context,
